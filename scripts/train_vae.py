...
def main():
    ...
    parser.add_argument(
        "--dataset", "-D", type=str, default="mnist", choices=["mnist", "cifar10"]
    )
    parser.add_argument(
    ...
    # Options
    optimization_args = {"optimizer": {"name": "adam", "lr": 1e-3}}

    with open(args.config, "r") as f:
        architecture_args = json.load(f)

    revert_normalization = lambda x: datasets.revert_normalization(
